# ReaFull — Legal Notice & Attribution

## 📜 Overview and Licensing Scope

The **ReaFull installer, configuration merging engine, and deployment scripts** are licensed under the [MIT License](LICENSE) © 2025–2026 Jules Martins (`julesklord`).

ReaFull is a curated Linux-native production suite distribution for **Cockos REAPER**. Bundled components (JSFX plugins, ReaScripts, themes, icons, templates, and fonts) are included with full credit to their respective authors and are governed by their original licenses (GPL-3.0, LGPL-3.0, MIT, Apache 2.0, and SIL Open Font License).

---

## 🎨 Creative Lineage & Workflow Foundations
- **ReArtist Pro**: Original workflow design, track templates architecture, analog console layout concept, and curated preset configurations by **Edu Serra** (licensed under LGPL v3).
- **Cockos REAPER**: Digital Audio Workstation created by **Cockos Incorporated**. REAPER is a registered trademark of Cockos Incorporated. (ReaFull is an independent open-source configuration and is not affiliated with Cockos Inc.)
